...
#line 27 "convert.y" /* yacc.c:1646  */
    {b=1;fprintf(yyout,"%s %d", (yyvsp[-1].txtval),stack[stkptr]); free((yyvsp[-1].txtval));}
#line 1222 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 28 "convert.y" /* yacc.c:1646  */
    {fprintf(yyout,"\n%s %d", (yyvsp[-1].txtval), stack[stkptr]); free((yyvsp[-1].txtval));}
...
#line 33 "convert.y" /* yacc.c:1646  */
    {(yyval.txtval)=strdup((yyvsp[0].txtval));   push(atoi((yyvsp[0].txtval)));  free((yyvsp[0].txtval));}
...
#line 34 "convert.y" /* yacc.c:1646  */
    {   int size = 2 + strlen((yyvsp[-2].txtval)) + strlen((yyvsp[-1].txtval)) + 2;
                            ...
                            strcat((yyval.txtval),"+ ");
                            strcat((yyval.txtval),(yyvsp[-2].txtval));
                            strcat((yyval.txtval)," ");
                            strcat((yyval.txtval),(yyvsp[-1].txtval));
